...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
            ...
            IEnumerable<object> result = Emps.GroupBy(e => e.Deptno)
                ...
                .Select(g => new
                {
                    name = Depts.Where(d => d.Deptno == g.Key).Select(d => d.Dname).FirstOrDefault(),
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.Task12(Emps);
            return result;
        }
        ...
        {
            int result = arr.GroupBy(e => e).FirstOrDefault(g => g.Count() % 2 == 1).First();
            //result=
            return result;
        }
        ...
        {
            var deptWith5Employees = Emps.GroupBy(e => e.Deptno)
                .Where(g => g.Count() == 5)
                .Select(g => g.Key);

            var deptWith0Employees = Depts
            ...
            IEnumerable<Dept> result = Depts
                .Where(d => deptWith5Employees.Contains(d.Deptno) || deptWith0Employees.Contains(d.Deptno))
                .OrderBy(d => d.Dname);
            //result =
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            return emps.Join(emps, e1 => e1, e2 => e2.Mgr, (e1,e2) => e1).OrderBy(e => e.Ename).ThenByDescending(e => e.Salary);
        }
    }
}